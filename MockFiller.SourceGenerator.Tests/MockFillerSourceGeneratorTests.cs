...
using MockFiller.SourceGenerator.Diagnostics;
using MockFiller.SourceGenerator.SourceGeneratorImplementations;
using VerifyCS =
    MockFiller.SourceGenerator.Tests.CSharpSourceGeneratorVerifier<
        MockFiller.SourceGenerator.SourceGeneratorImplementations.MockFillerSourceGenerator>;

namespace MockFiller.SourceGenerator.Tests;
