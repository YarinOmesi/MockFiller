...
public class FileBuilder
{
    ...
    public CompilationUnitSyntax Build()
    {
        ...
        SyntaxTrivia[] fileHeaderTrivia = new [] {
            SyntaxFactory.Comment("// <auto-generated/>"),
        };
        
        var namespaceSyntax = SyntaxFactory.NamespaceDeclaration(SyntaxFactory.ParseName(Namespace))
            .WithNamespaceKeyword(SyntaxFactory.Token(SyntaxFactory.TriviaList(fileHeaderTrivia), SyntaxKind.NamespaceKeyword, SyntaxFactory.TriviaList()))
